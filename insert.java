...
//            try {
//                Connection con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=LMS;encrypt=true;trustServerCertificate=true","sa","1234");
//                 //PreparedStatement ps = con.prepareStatement("insert into student([name],email,grade,year)values('"+name+"','"+email+"','"+grade+"','"+year+"')");
//           PreparedStatement ps = con.prepareStatement("insert into student(name,ID,email,grade,year)values(?,?,?,?,?");
//           
//         ps.setString(1,name);
//         ps.setString(2,ID);
...
//        }   
            ...
            String url = "jdbc:sqlserver://localhost:1433;databaseName=LMS;user=sa;password={1234};encrypt=true;trustServerCertificate=true";
            try {
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
...
//            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
//                Connection con = DriverManager.getConnection(url);
//            String query="update studeent set name ='"+name+"' , year ='"+year+"' , email = '"+email+"', grade ='"+grade+"where ID ='"+ID+"'";
//                
////PreparedStatement ps = con.prepareStatement("insert into student([name],email,grade,year)values('"+name+"','"+email+"','"+grade+"','"+year+"')");
//           Statement ps = con.createStatement();
//           ps.executeUpdate(query);
